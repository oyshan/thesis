...
\cite{hei} % bare tester bruk av en referanse her
%% include here the other chapters
\include{introduction}
\include{use_case_study}
\include{requirements}
\include{sota_related}
\include{design}
...
\bibliography{main}
% refs vil ikke dukke opp med mindre man citer dem. Etter man har citet: f6+f11+f6+f6
